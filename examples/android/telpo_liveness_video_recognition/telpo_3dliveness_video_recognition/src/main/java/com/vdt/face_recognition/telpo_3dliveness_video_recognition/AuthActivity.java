...
import com.vdt.face_recognition.telpo_3dliveness_video_recognition.TheCamera;
		...
		VideoStream.NewFrameListener
{
	...
	private void starting()
	{
		try
		{
			...
			rgb_camera = new TheCamera(this, 0);
	...
	private void starting_ir()
	{
		try {
			...
			ir_camera = new TheCamera(this, 1);
	...
	// camera object will call this when new IR frame arrive
	@Override
	...
	public void call(final TrackingCallbackData data)
	{
		...
		synchronized(dsv.circles_data)
		{
			...
			int image_width = rgb_camera.getWidth();
			int image_height = rgb_camera.getHeight();

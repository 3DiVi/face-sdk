...
def help_message():
    message = f"\n This program is an example of the Gender Estimator Processing block integration \n Usage: " \
...
def gender_estimator(input_image, sdk_path, use_cuda):
    ...
    gender_block = service.create_processing_block(gender_config)  # create gender estimation processing block
...
if __name__ == "__main__":
    ...
    gender_estimator(args.input_image, args.sdk_path, args.use_cuda)

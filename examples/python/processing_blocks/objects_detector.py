...
def help_message():
    message = f"\n This program is an example of the Object Detector Processing block integration \n Usage: " \
...
def objects_detector(input_image, sdk_path, use_cuda):
    ...
    detector_block = service.create_processing_block(detector_config)  # create an object detector processing block
    ...
    detector_block(ioData)  # call an object detector block and pass a container with an image
...
if __name__ == "__main__":
    ...
    objects_detector(args.input_image, args.sdk_path, args.use_cuda)

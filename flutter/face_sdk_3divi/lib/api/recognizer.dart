...
///[return] - Loaded template.
  Template loadTemplate(Uint8List binary_stream){
    var exception = _getException();
    final loadTemplate = _dll_handle.lookupFunction<_Recognizer_load_template_c, _Recognizer_load_template_dart>
    ...
    final templPointer = loadTemplate(
        _impl,
        _templatePointerStructure.cast(),
        Pointer.fromFunction(readFunc),
        exception);
    checkException(exception, _dll_handle);
...
///[return] - Created index.
  TemplateIndex createIndex(
    ...
    var exception = _getException();
    final _createIndex = _dll_handle.lookupFunction<_Recognizer_create_index_c, _Recognizer_create_index_dart>
      (_c_namespace + 'Recognizer_createIndex');
    ...
    final templIndexPointer = _createIndex(
        _impl,
        templates.length,
        templatesImpl,
  ...
  List<SearchResult> singleSearch(
    ...
    final _search = _dll_handle.lookupFunction<
        _Recognizer_search_v2_c,
        _Recognizer_search_v2_dart>
      (_c_namespace + 'Recognizer_search_v2');
    final exception = _getException();
...
/// in ascending order of distance to the query_template.
  List<List<SearchResult>> search(
      ...
      TemplateIndex templates_index,
      int k,
      {SearchAccelerationType acceleration =
          SearchAccelerationType.SEARCH_ACCELERATION_1}){
    final _search = _dll_handle.lookupFunction<_Recognizer_search_v2_c, _Recognizer_search_v2_dart>
      (_c_namespace + 'Recognizer_search_v2');
    final exception = _getException();
  ...
  MatchResult getRocCurvePointByFar(double far_threshold){
    final get_roc_curve = _dll_handle.lookupFunction<_Recognizer_get_roc_curve_c, _Recognizer_get_roc_curve_dart>

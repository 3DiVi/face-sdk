...
* [Использование GPU](development/gpu_usage.md) – руководство по использованию GPU для ускорения работы модулей Face SDK на платформах Linux x86 64-bit и Android

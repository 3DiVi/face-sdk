...
* [Создание базы лиц](#создание-базы-лиц)
* [Поиск лица по базе и отображение результата в консоли](#поиск-лица-по-базе-и-отображение-результата-в-консоли)
* [Отображение превью распознанного лица из базы](#отображение-превью-распознанного-лица-из-базы)

...
* LBF - стандартный детектор 
* BLF – новый детектор, более быстрый по сравнению с LBF, обеспечивает большую точность детекции лиц в масках
* REFA - новый детектор, более медленный по сравнению с детекторами LBF и BLF, но при этом гарантирует наилучшее качество детекции. Рекомендован для использования в экспертных системах. 
...
|video_worker_fdatracker_refa_fda.xml|refa|fda|[-70;70][-90;90][-70;70]|Детектор лиц, рекомендуемый для использования в экспертных системах. Обеспечивает детекцию лиц с наибольшим покрытием углов поворота и максимальным качеством (в т.ч. в масках).|
